...
(18, 'Máy đo huyết áp Omron HEM-7121J', 'Omron', 'machine', 'Máy đo huyết áp Omron Hem-7121J tự động với công nghệ IntelliSense mang lại sự thoải mái cho người dùng. Nó báo OK khi quấn vòng bít đúng cách, đảm bảo áp suất phù hợp để cho kết quả chính xác, nhanh chóng. Dễ dàng theo dõi huyết áp tại nhà.', 'Omron Blood Pressure Monitor HEM-7121J, đo huyết áp', 'Blood Pressure.jpg', 48, 530000),
...
(33, 'Dầu dưỡng da Sri Sri Tattva - 200ml', 'Sri Sri', 'self-care', 'Dầu dưỡng Sri Sri Tattva chứa thành phần tự nhiên và tinh dầu giúp nuôi dưỡng, phục hồi làn da hư tổn, cải thiện tình trạng da, làm mờ dấu hiệu lão hóa.', 'Sri Sri Tattva Body Oil, 200 ml', 'Sri Sri Tattva Body Oil, 200 ml.jpeg', 47, 39000),
...
(45, 'Thuốc cảm ho thảo dược Zinda Tilismath 5 ml', 'Zinda', 'medicine', 'Zinda Tilismath là thuốc thảo dược 100% điều trị các bệnh thông thường như cảm, ho.', 'Zinda Tilismath Unani Medicine, 5 ml', 'Zinda Tilismath Unani Medicine, 5 ml.jpeg', 48, 36000),
...
(49, 'Viên hỗ trợ tiểu đường Himalaya Diabecon DS (60 viên)', 'Himalaya', 'medicine', 'Diabecon DS hỗ trợ quản lý tiểu đường, là công thức Ayurvedic chứa các thành phần như Gymnema, shilajeet.', 'Himalaya Diabecon DS ,60 Tablets', 'Himalaya Diabecon DS ,60 Tablets.jpeg', 47, 46000),
